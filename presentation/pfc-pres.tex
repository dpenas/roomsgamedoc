...
\pdfinfo
{
  /Title       (Desarrollo de un videojuego roguelike para invidentes aplicando técnicas de Procesamiento del Lenguaje Natural.)
...
\frame{
  ...
  \begin{flushright}
    ...
    \structure{\footnotesize{dario.penas@udc.es}}
  \end{flushright}
}
